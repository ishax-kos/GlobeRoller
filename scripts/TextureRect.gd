...
const shader_rec_pol := preload("res://shaders/from_rec_pol.shader")
const shader_pol_rec := preload("res://shaders/from_pol_rec.shader")
const shader_base := preload("res://shaders/base.shader")
